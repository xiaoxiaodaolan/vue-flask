<template>
  <div id="all">
	  ...
	  <div id="div1">
		  <el-input class="el-input" @click.native="againclick()" placeholder="请输入学号" v-model="username"></el-input>
		  <el-button type="primary" icon="el-icon-search" @click="queryyonghupwd()()">搜索</el-button>
	  	<table class="table1">
