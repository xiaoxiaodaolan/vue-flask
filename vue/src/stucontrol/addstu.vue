  ...
  <div id="all">
	  ...
	  <table class="table2">
	  	<td>
	  		...
	  		<p>学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:<input type="number" v-model="sno" /></p>
			...
			<p><el-button type="primary" round @click="addstudent()">确定</el-button></p>
...
<script>
	export default{
		...
		methods:{
			...
			addstudent(){
				if(this.stuname.length != 0 && this.sno.length !=0 && this.college.length !=0 && this.grade.length !=0 && this.cls.length !=0 && this.tel.length !=0){
					var newstudent = new URLSearchParams();
					newstudent.append('stuname', this.stuname);
					newstudent.append('sno', this.sno);
					newstudent.append('college', this.college);
					newstudent.append('grade', this.grade);
					newstudent.append('cls', this.cls);
					newstudent.append('tel', this.tel);
					this.$http.post('http://127.0.0.1:9000/addstudent',newstudent)
					.then(res => {
						newstudent.stuname = this.stuname;
						newstudent.sno = this.sno;
						newstudent.college = this.college;
						newstudent.grade = this.grade;
						newstudent.cls = this.cls;
						newstudent.tel = this.tel;
